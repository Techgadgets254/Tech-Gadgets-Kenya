    ...
    const fetchMetadata = async () => {
      try {
        ...
        if (snap.exists()) {
          ...
          setTitle("Tech Gadgets Kenya | Authorized Apple, HP & ASUS Dealer");
      ...
      <form onSubmit={handleSave} className="space-y-6 text-left">
        ...
        <div>
          ...
          <input
            ...
            placeholder="e.g. Tech Gadgets Kenya | Premium Apple & Dell Laptops Nairobi"
        ...
        <div>
          ...
          <input
            ...
            placeholder="e.g. nairobi laptops, genuine macbook kenya, tech gadgets, waiyaki way gadgets"
