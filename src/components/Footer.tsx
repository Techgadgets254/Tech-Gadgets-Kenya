    ...
    <footer id="storefront-footer" className="bg-[#050505] text-white/50 font-sans border-t border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-white/10 mt-12 pt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-xs">
          <div>
            <p>© {new Date().getFullYear()} Tech Sokoni Kenya. All rights reserved.</p>
            {/* Social media connections */}
            <div className="flex gap-4 mt-3 justify-center md:justify-start">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#C5A059] text-white/40 transition-colors" title="Tech Sokoni Kenya Facebook">
                <Facebook className="w-4 h-4" />
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#C5A059] text-white/40 transition-colors" title="Tech Sokoni Kenya on X">
                <Twitter className="w-4 h-4" />
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#C5A059] text-white/40 transition-colors" title="Tech Sokoni Kenya Instagram">
                <Instagram className="w-4 h-4" />
              </a>
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#C5A059] text-white/40 transition-colors" title="Tech Sokoni Kenya YouTube Channel">
