...
export default function ClientDashboard() {
  ...
  const handleDownloadInvoicePDF = (order: Order | null) => {
    ...
    doc.text("Tech Soko Kenya | East Africa Premium Electronics Importers", 105, 279, { align: "center" });
  ...
  const handleDownloadStatementPDF = () => {
    ...
    doc.text("Tech Soko Kenya eTIMS Ledger API integration is verified and active.", 105, 279, { align: "center" });

    doc.save(`Tech_Soko_Kenya_Tax_Statement_${user?.uid.substring(0,6)}.pdf`);
  };
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div className="text-left">
                  ...
                  <p className="text-white/40 text-[11px] leading-relaxed mt-1">
                    Refer clients to Tech Soko Kenya and earn rewards. Your friends receive a <span className="text-[#C5A059] font-bold">KES 1,000 instant discount</span> on checkout in our online catalog!
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    onClick={() => {
                      ...
                      const shareTxt = `Use my partner coupon "${code}" during checkout to save KES 1,000 on your purchase at Tech Soko Kenya!`;
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div className="text-center text-[9px] text-white/20 font-mono mt-10 pt-4 border-t border-white/5 leading-normal">
                    <p>Thank you for shopping at Tech Soko Kenya.</p>
          ...
          {!settingsKraPin && !settingsShippingCounty && !settingsPaymentPhone && !showSettingsForm ? (
            <div className="bg-[#0F0F0F] border border-dashed border-[#C5A059]/20 rounded-3xl p-10 text-center animate-fadeIn py-14 shadow-xl">
              ...
              <p className="text-white/40 text-xs mt-2 max-w-sm mx-auto leading-relaxed">
                Configure your display phone billing, tax codes, and default delivery channels. This allows Tech Soko Kenya to pre-populate custom layouts cleanly.
              </p>
              <button
                type="button"
                    ...
                    <form onSubmit={handleSaveSettings} className="space-y-4">
                      ...
                      <div className="bg-[#0A0A0A] border border-white/5 rounded-2xl p-4 flex items-center justify-between">
                        <div className="text-left">
                          ...
                          <p className="text-white/30 text-[10px] mt-0.5 font-sans">Authorize Tech Soko Kenya to email you weekly stock drops.</p>
                        </div>
                        <input
                          type="checkbox"
